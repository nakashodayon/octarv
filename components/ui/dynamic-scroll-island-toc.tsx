...
const DynamicScrollIslandTOC = ({
  ...
  useEffect(() => {
    ...
    resizeObserver.observe(c === window ? document.body : (c as HTMLElement).firstChild as Element);
...
function Text({
  ...
  sp,
  lPrefix,
}: Props & { open: boolean; sp: MotionValue<number> }) {
