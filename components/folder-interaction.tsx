    ...
    <div className="flex flex-col items-center gap-2">
      ...
      >
        <div
          ...
          style={{
            background: "#18151B",
            boxShadow: "0px 0px 8px 8px rgba(79, 73, 85, 0.30) inset",
            borderRadius: 8,
          }}
        >
          {[
            {
              initial: { rotate: -3, x: -12, y: 2 },
              open: { rotate: -8, x: -24, y: -20 },
              transition: {
                ...pageVariants.spring,
                bounce: 0.15,
                stiffness: 160,
            ...
            {
              initial: { rotate: 3.5, x: 14, y: 1 },
              open: { rotate: 9, x: 26, y: -22 },
              transition: {
                ...pageVariants.spring,
                duration: 0.58,
                bounce: 0.17,
        ...
        >
          ...
          >
            ...
            <path
              ...
              fill="url(#paint0_linear_folder)"
              fillOpacity="0.3"
              stroke="url(#paint1_linear_folder)"
              strokeWidth="0.7"
            />
            <defs>
              <clipPath
                id="bgblur_folder_clip_path"
...
const Page = () => (
  <div className="w-full bg-gradient-to-b from-[#E8E7F0] to-[#DCDAE8] rounded-md shadow-lg p-2 py-3">
